  ...
  <head>
	...
	<script type="text/javascript">
			...
			$(".jian").click(function() {
				...
				if(quantity == 1) {
					if(confirm("您是否真要删除该条目？")) {
						location = "/bs/CartItemServlet?method=batchDelete&cartItemIds=" + id;
					}
				} else {
		...
		function batchDelete() {
			...
			location = "/bs/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
		}
